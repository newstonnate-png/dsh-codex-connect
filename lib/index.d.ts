...
declare const SUPPORTED_DSH_PLUGIN_API_VERSION = "0.1.6-alpha.1";
declare const SUPPORTED_DSH_PLUGIN_API_VERSIONS: readonly ["0.1.6-alpha.1"];
...
declare const COMPATIBILITY_CONTRACT: {
  ...
  readonly dshPluginApi: {
    readonly version: "0.1.6-alpha.1";
    readonly versions: readonly ["0.1.6-alpha.1"];
