...
| GPT Image generation and editing | `enableImageGeneration` | Generates from text and edits images taken from the conversation; availability, dimensions, and quota remain account- and service-controlled. |
